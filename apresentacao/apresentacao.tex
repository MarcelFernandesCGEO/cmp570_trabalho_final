...
\begin{frame}{O que é o SATLAS?}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.42\textwidth}
      \centering
      \includegraphics[width=\linewidth]{satlas_intro_comparison.png}\\[0.3em]
      {\small Exemplo SATLAS: Sentinel-2 ($\sim$10\,m/px) $\to$ SR ($\sim$2{,}5\,m/px).\\
       Estrada e bordas de mata invisíveis no LR, nítidas no SR.}
    \end{column}
  \end{columns}
